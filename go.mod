...
require (
	...
	github.com/metal3-io/baremetal-operator/apis v0.1.2 // indirect
	...
	github.com/openshift/assisted-service v0.0.0-20220928142635-a40422bdea61 // indirect
...
replace (
	...
	github.com/metal3-io/baremetal-operator => github.com/openshift/baremetal-operator v0.0.0-20221202075057-bc3fe35f8b62 // Use OpenShift fork
	github.com/metal3-io/baremetal-operator/apis => github.com/openshift/baremetal-operator/apis v0.0.0-20221202075057-bc3fe35f8b62 // Use OpenShift fork
	github.com/metal3-io/baremetal-operator/pkg/hardwareutils => github.com/openshift/baremetal-operator/pkg/hardwareutils v0.0.0-20221202075057-bc3fe35f8b62 // Use OpenShift fork
	github.com/metal3-io/cluster-api-provider-baremetal => github.com/openshift/cluster-api-provider-baremetal v0.0.0-20190821174549-a2a477909c1d // Pin OpenShift fork
	github.com/mholt/certmagic => github.com/caddyserver/certmagic v0.15.0
	github.com/openshift/api => github.com/openshift/api v0.0.0-20230213134911-7ba313770556
	...
	sigs.k8s.io/cluster-api-provider-azure => github.com/openshift/cluster-api-provider-azure v0.1.0-alpha.3.0.20221010142932-d1d4f7700ca6
	sigs.k8s.io/cluster-api-provider-openstack => github.com/openshift/cluster-api-provider-openstack v0.0.0-20221020072535-8bd9c35fa7df
...
replace (
	// This repo is a new dependency that wasn't there in 4.11, and in this commit they add a require to a module in the same tree with an invalid version,
	// but also add a replace statement to use the local module, ie. `github.com/openshift/assisted-service/api` v0.0.0 and `replace github.com/openshift/assisted-service/api => ./api`
